...
def main_window():
  ...
  ice_cream_type_menu.menu.add_command(
      ...
      image=cone_photo,
      compound="left",
      command=lambda: ice_cream_type_var.set("Cone"))
  ice_cream_type_menu.menu.add_command(
      label="Sundae",
      image=sundae_photo,
      compound="left",
      command=lambda: ice_cream_type_var.set("Sundae"))
  ...
  # Toppings
  toppings_list = [
      "Nuts", "Chocolate", "Strawberry Syrup", "Pineapple Syrup", "Whip Cream",
      "Sprinkles", "Sugar Cookies", "Bananas", "Cherry"
  ]
  ...
  for topping in toppings_list:
    ...
    chk = tk.Checkbutton(
        ...
        onvalue=True,
        offvalue=False,
        command=lambda topping=topping, var=var: update_toppings(var, topping))
    chk.pack()
